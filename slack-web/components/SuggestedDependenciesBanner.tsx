...
export const SuggestedDependenciesBanner: React.FC<SuggestedDependenciesBannerProps> = ({
  ...
  return (
    <div className="border-b border-[var(--border)] bg-[#FFFBF5] px-6 py-2.5">
          ...
          {suggestions.map((sugg, index) => {
            ...
            return (
              <div
                ...
                className="flex flex-wrap items-center justify-between gap-3 border border-[var(--border)] bg-[var(--card)] px-4 py-2 text-xs"
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 border border-[var(--foreground)] bg-[var(--foreground)] px-3 py-1 text-xs font-medium text-[var(--background)] hover:bg-[#38332B] transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 border border-[var(--border-strong)] bg-[var(--card)] px-3 py-1 text-xs font-medium text-[var(--muted-foreground)] hover:text-[var(--foreground)] hover:border-[var(--foreground)] transition-colors"
                  >
